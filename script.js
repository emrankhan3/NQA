      ...
      lessons: [
        ...
        },
        {
          ...
          vocabulary: [
            ...
            {
              bangla: "ধনী",
              arabic: "غَنِيٌّ - غَنِيَّةٌ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "গরিব",
              arabic: "فَقِيرٌ - فَقِيرَةٌ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "মেধাবী",
              arabic: "ذَكِيٌّ - ذَكِيَّةٌ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "নির্বোধ/অবিবেচক/ছাত্রলীগ",
              arabic: "غَبِيٌّ - غَبِيَّةٌ",
              showBangla: true,
              showArabic: true,
            },
            {
        ...
        },
        {
          ...
          vocabulary: [
            ...
            {
              bangla: "একটি চমৎকার সময়",
              arabic: "وَقْتٌ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "চমৎকার সময়গুলো",
              arabic: "أَوْقَاتٌ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "এটি (পুরুষের জন্য)",
              arabic: "هَذَا",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "এটি (নারীর জন্য)",
              arabic: "هَذِهِ",
              showBangla: true,
              showArabic: true,
            },
        ...
        },
        {
          ...
          vocabulary: [
            {
              bangla: "তার বই",
              arabic: "كِتَابُهُ - كِتَابُهَا",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "তাদের বই",
              arabic: "كِتَابُهُمْ - كِتَابُهُنَّ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "তোমার বই",
              arabic: "كِتَابُكَ - كِتَابُكِ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "তোমাদের বই",
              arabic: "كِتَابُكُمْ - كِتَابُكُنَّ",
              showBangla: true,
              showArabic: true,
            },
            {
            ...
            {
              bangla: "স্বামী/স্ত্রী",
              arabic: "زَوْجٌ - زَوْجَةٌ",
              showBangla: true,
              showArabic: true,
            },
            {
              bangla: "স্বামীরা/স্ত্রীরা",
              arabic: "أَزْوَاجٌ",
              showBangla: true,
              showArabic: true,
            },
        ...
        },
        {
          ...
          vocabulary: [
            ...
            {
              bangla: "আল্লাহর কাছে সবচেয়ে প্রিয়",
              arabic: "أَحَبُّ إِلَى اللهِ",
              showBangla: true,
              showArabic: true,
            },
          ],
